...
# load dictionaries and train samples
...
train_captions = np.load('train_captions.npy', encoding='latin1', allow_pickle=True)

# check if the length of training data is equal, otherwise raise assertion error flag
...
sample_sentence = ["this flower has petals that are yellow and very stringy"] * int(sample_size/ni) + \
                  ["this flower is white in color, and has petals that are that are ruffled."] * int(sample_size/ni) + \
                  ["this flower has small white stamen, a large white petal, and a yellow ovary."] * int(sample_size/ni) + \
                  ["this white flower has many petals with prominent yellow color anthers"] * int(sample_size/ni) + \
                  ["this flower has a ring of slightly overlapping rounded peach petals with darker veins."] * int(sample_size/ni) + \
                  ["this flower is pink in color, with petals that are leaf like."] * int(sample_size/ni) + \
                  ["this flower has petals with pointed yellow tips and a red color closer to the base."] * int(sample_size/ni) +\
                  ["this flower is pink and yellow in color, with petals that are curled around the center."] * int(sample_size/ni)
