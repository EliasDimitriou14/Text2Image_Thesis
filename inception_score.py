...
# my code to format the images to get inception score
import os
...
# create an array to store them as numpy array.That is the input for the inception score code
images_array = []
for image in images:
...
# Calculate the inception score of the images and show the mean and the std
mean, std = get_inception_score(transposed_images, splits=10)
print("Mean:", mean)
